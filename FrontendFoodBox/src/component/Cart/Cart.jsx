            ...
            <main className="lg:flex justify-between">
                <section className="lg:w-[30%] space-y-6 lg:min-h-screen pt-10">
                    ...
                    <div className="billDetails px-5 text-sm">
                        <p className="font-axtralight py-5">Bill Details</p>
                ...
                <section className="lg:w-[70%] flex justify-center px-5 pb-10 lg:pb-0">
                    <div>
                        <h1 className="text-center font-semibold text-2xl py-10">Chooce Delivery Address</h1>
                        <div className="flex gap-5 flex-wrap justify-center">
                            {order.orders.map((item) => (
                                <AddressCard handleSelectAddress={createOrderUsingSelectedAddress} item={item} showButton={true} />))}
                            <Card className="flex gap-5 w-50 p-5">
                                <AddLocation />
                ...
                <Box sx={style}>
                    ...
                    onSubmit={handleSubmit}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <Button fullWidth variant="contained" type="submit" color="primary">Delever Here</Button>
